...
const Orders = ({ navigate }: Navigate) => {
    ...
    const orderDescRange: string[] = [
        "Aguardando aprovação",
        "Aguardando Pagamento",
        "Pedido Rejeitado - Entre em contado para mais informações",
        "Alocar Recursos",
        "Aguardando motorista sair para retirar carga",
        "Motorista preparando transporte",
        "Motorista em trânsito para retirar pedido",
        "Pedido coletado",
        "Motorista em trânsito para entrega do do pedido",
            ...
            {hasUser &&
                <>
                    ...
                    {orders.map((order, key) => {
                        ...
                        const hasIssue = (orderDescRange.indexOf(order.statusdesc) > -1);
                                ...
                                <div className="order">
                                    ...
                                    <div className="row">
                                        <div className="field mobile-field" id="status-field">
                                            ...
                                            <div className="content-field mobile-field">{!hasIssue ? 'Problemas internos - Você será atualizado em breve' : order.statusdesc}</div>
                                        </div>
                                    </div>
